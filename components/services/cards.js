...
export default function Cards() {
  ...
  <div className="container px-5 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Our Services
      </h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Our range of services help organizations succeed in this demanding environment by leveraging our technological and industry expertise, producing innovative and practical solutions
      </p>
    </div>
    <div className="flex flex-wrap -m-4 text-center">
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-2xl text-gray-900">SAP
          </h2>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        ...
        <Image src="/services/consulting-512x512.png" width="80" height="80"/>
          <h2 className="title-font font-medium text-2xl text-gray-900">IT
          </h2>
          <p className="leading-relaxed">Consulting
          </p>
        </div>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        ...
        <Image src="/services/is-oil-512x512.png" width="80" height="80"/>
          <h2 className="title-font font-medium text-2xl text-gray-900">IS OIL
          </h2>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        ...
        <Image src="/services/talent-512x512.png" width="80" height="80"/>
          <h2 className="title-font font-medium text-2xl text-gray-900">TALENT
          </h2>
    ...
    <div className="flex justify-center flex-wrap -m-4 text-center">
      <div className="p-4 sm:w-1/2 w-full md:w-1/4">
        ...
        <Image src="/services/migration-512x512.png" width="80" height="80"/>
          <h2 className="title-font font-medium text-2xl text-gray-900">CLOUD
          </h2>
      ...
      <div className="p-4 sm:w-1/2 w-full md:w-1/4">
        ...
        <Image src="/services/cloud-512x512.png" width="80" height="80"/>
          <h2 className="title-font font-medium text-2xl text-gray-900">HANA
          </h2>
      ...
      <div className="p-4 sm:w-1/2 w-full md:w-1/4">
        ...
        <Image src="/services/support-512x512.png" width="80" height="80"/>
          <h2 className="title-font font-medium text-2xl text-gray-900">SUPPORT
          </h2>
