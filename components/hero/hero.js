    ...
    <section className="leading-normal tracking-normal py-80 pt-10 bg-cover md:bg-cover bg-[url('/hero/bg-hero-1000x666.png')] ">
      <div className="grid grid-rows-1 grid-cols-2 gap-2 mr-10 py-20 ">
        <div className="row-span-1 col-span-1 ">
          <div className=" ml-20">
            <h1 className="mb-10 font-bold drop-shadow-lg text-4xl md:text-5xl max-w-xl text-white leading-tight">Dont listen to what they say, Go See</h1>
          </div>
        ...
        <div className="row-span-1 col-span-1">
          <div className="grid grid-cols-14 grid-flow-col gap-4 ml-4">
            ...
            <div className="col-start-3 col-end-10 -mt-20 -ml-12 "><Image className=" shadow shadow-teal-600 backdrop-opacity-50 rounded-xl" src="/hero/bg-sec1-1000x666.png" height='250' width='400' alt="hero3"/></div>
