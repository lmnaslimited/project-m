export default function Index() {
    return (
        <section classNameName="bg-purple-50 ">
            ...
            <div className="px-4 py-32 my-40 shadow-white shadow-lg rounded-3xl mx-auto max-w-7xl ">
            <div className="flex flex-col text-center w-full mb-20">
                ...
                <div className="bg-gray-800 shadow-amber-500 shadow-lg rounded-3xl transform transition hover:scale-105 duration-300 ease-in-out p-8 grid items-center w-full grid-cols-1 gap-10 mx-auto lg:grid-cols-8 lg:gap-4 xl:w-3/4">
