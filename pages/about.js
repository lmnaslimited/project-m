  ...
  <header className="text-white body-font bg-th-background">
    ...
    <span className="ml-3 text-xl">Tidal Groups</span>*/}
     ...
     <div className="flex flex-col justify-center text-center">
       <h1 className="font-sans font-bold mt-4 md:mt-0 lg:text-5xl md:text-3xl text-2xl text-th-primary-dark">Our <span className="text-th-primary-medium">strength</span>
