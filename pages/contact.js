        ...
        <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div className="text-center text-th-primary-dark mb-10">
                    <h1 className="font-bold text-3xl text-th-primary-medium">Let Connect Us</h1>
                    ...
                    <div className="flex -mx-3">
                        ...
                        <div className="w-1/2 px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg  outline-none focus:border-indigo-500" placeholder="Smith" />
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg  outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
            ...
            <textarea id="message" name="message" class="w-full bg-white rounded  focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
          </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
...
<div className="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a title="home" href="telto:+44 2030062716 / +44 7535029430" target="_blank" className="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
            <img className="object-cover object-center w-full h-full rounded-full" src="https://o.remove.bg/downloads/59ed208c-607d-4e03-836b-5a44068fc673/phone_53876-25489-removebg-preview.png"/>
        </a>
    </div>
</div>
